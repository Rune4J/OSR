...
public class RiftInstanceEvent extends Event<RiftInstance> {
...
//    }
    ...
    public RiftInstanceEvent(int id, RiftInstance attachment, int ticks) {
        super("rift-instance-" + id, attachment, ticks);
    }
}
