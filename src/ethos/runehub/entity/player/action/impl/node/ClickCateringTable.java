...
public class ClickCateringTable extends ClickNodeAction {
    ...
    public void perform() {
        if (player.getContext().getPlayerSaveData().getActiveJob() != 0L) {
            ...
            if (job.getSkillId() == 7) {
                ...
                player.sendMessage("This box is for food only.");
            }
        } else {
    ...
    public ClickCateringTable(Player player, int nodeX, int nodeY, int nodeId) {
