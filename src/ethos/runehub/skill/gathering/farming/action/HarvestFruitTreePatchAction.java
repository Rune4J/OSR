...
public class HarvestFruitTreePatchAction extends HarvestPatchAction {

    private static final Logger logger = LoggerFactory.getLogger(HarvestFruitTreePatchAction.class.getName());
    ...
    protected void validateWorldRequirements() {
        Preconditions.checkArgument(PreconditionUtils.isFalse(patchContext.getCurrentGrowthStage() == patchContext.getMaturityStage()), "This tree has nothing to harvest.");
    }
    ...
    public HarvestFruitTreePatchAction(Player player, int nodeId, int nodeX, int nodeY, PatchContext patchContext) {
