...
public class FletchLogsAction extends SkillAction {
    ...
    protected void validateItemRequirements() {
        Preconditions.checkArgument(this.getActor().getItems().playerHasItem(946), "You need a @" + 946);
    ...
    public FletchLogsAction(Player actor, Fletchable fletchable, int amount) {
