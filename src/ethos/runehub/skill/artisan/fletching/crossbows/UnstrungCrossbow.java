...
@StoredObject(tableName = "unstrung_crossbow")
public class UnstrungCrossbow {
    ...
    public UnstrungCrossbow(int bowId, GameItem[] materials, boolean members, int baseXp, int levelRequirement) {
        this.bowId = bowId;
