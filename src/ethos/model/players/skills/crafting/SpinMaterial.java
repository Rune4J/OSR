...
public class SpinMaterial {
	...
	private final class SpinEvent extends Event<Player> {
		...
		public void execute() {
			...
			attachment.getPA().addSkillXP((int) (material.experience * (attachment.getMode().getType().equals(ModeType.OSRS) ? 1 : Config.CRAFTING_EXPERIENCE * attachment.prestige())), Player.playerCrafting, true);
