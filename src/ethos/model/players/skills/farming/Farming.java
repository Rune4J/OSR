...
/*              if (id >= 4 && player.amountDonated < 150) {
                ...
                if (itemId == herb.getSeedId() && player.getItems().playerHasItem(FarmingConstants.SEED_DIBBER)) {
                    ...
                    double regExperience = herb.getPlantingXp() * ((Config.FARMING_EXPERIENCE * player.prestige()) + (hasMagicSecateurs() ? 1 : 0)) + herb.getPlantingXp() * Config.FARMING_EXPERIENCE / 20 * pieces;
            ...
            if(player.getFarmingState(id) == State.HARVEST.getId()) {
                ...
                double regHarvestExperience = herb.getHarvestingXp() * (Config.FARMING_EXPERIENCE * player.prestige()) + herb.getHarvestingXp() * Config.FARMING_EXPERIENCE / 5 * pieces;
                if(player.debugMessage)
