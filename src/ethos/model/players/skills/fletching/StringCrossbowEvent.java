...
public class StringCrossbowEvent extends Event<Player> {
	...
	public void execute() {
		...
		attachment.getPA().addSkillXP((int) ((int) crossbow.getExperience() * (attachment.getMode().getType().equals(ModeType.OSRS) ? 1 : Config.FLETCHING_EXPERIENCE * attachment.prestige())), Skill.FLETCHING.getId(), true);
	}
