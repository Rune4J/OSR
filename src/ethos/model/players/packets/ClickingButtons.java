...
public class ClickingButtons implements PacketType {
    ...
    public void processPacket(final Player c, int packetType, int packetSize) {
        ...
        System.out.println("Action button clicked: " + actionButtonId);
        
        if (c.isFrozen || c.isDead || c.getHealth().getAmount() <= 0) {
            return;
        }
        ...
        if (c.getLootingBag().handleButton(actionButtonId) ||
            c.getPrestige().prestigeClicking(c, actionButtonId) ||
            c.getExpLock().ExpLockClicking(c, actionButtonId) ||
            c.getRunePouch().handleButton(actionButtonId)) {
            return;
        }
        ...
        // Debugging book interface button clicks
        if (c.getCurrentBookId() > 0) {
            System.out.println("Handling book interface click for book ID: " + c.getCurrentBookId());
            switch (actionButtonId) {
                case 7073: // Left arrow button
                    System.out.println("Left arrow clicked");
                    BookUI.handleBookInterfaceClick(c, 1864); // Left arrow ID
                    break;
                case 7075: // Right arrow button
                    System.out.println("Right arrow clicked");
                    BookUI.handleBookInterfaceClick(c, 1866); // Right arrow ID
                    break;
                default:
                    System.out.println("Unhandled button ID: " + actionButtonId);
                    break;
            }
        }
...
//                break;
            ...
            case 113230:
                ...
                break;
                // OLD ACHIEVEMENTS - MICHAEL
            case 179182:
                c.getAchievements().currentInterface = 0;
                c.getAchievements().drawInterface(0);
                break;
            // NON WORKING BUTTONS - MICHAEL   
                
            case 223128: // ACHIEVEMENT DIARY MEDIUM
            	c.sendMessage("This will be included in a future update! Finish the Easy Diary for now.");
            	break;            	
            case 223129: // ACHIEVEMENT DIARY HARD
            	c.sendMessage("This will be included in a future update! Finish the Easy Diary for now.");
            	break;
            case 108003: // PRICE CHECKER
            	c.sendMessage("This will be included in a future update! We are working on this content.");
            	break;
...
//                break;
            ...
            case 185152:
                ...
                break;
          //  case 223128: OLD ACHIEVEMENT - MICHAEL
            case 185148:
...
//                break;
		...
		case 58034:
            ...
            case 108005:
                ...
                break;
            case 225228:
            	c.sendMessage("For more information I should talk to the Estate Agent in New Draynor.");
            	break;
            case 225229:
            	c.sendMessage("I can probably find a Guide for Sailing on Discord or by talking to the Port Master.");
        ...
        //    case 223033:
         ...
         //   case 223035:
          ...
          //  case 223037:
            ...
            case 210244: // LOGIN INTERFACE - MICHAEL
            case   7026:
            	 c.getPA().closeAllWindows();
            	 break;
            	
            case 59229: // Fix for Trade Session issues - MICHAEL
                c.getPA().closeAllWindows();
                System.out.println("Trade decline button pressed by player: " + c.playerName);
                MultiplayerSession tradeSession = Server.getMultiplayerSessionListener().getMultiplayerSession(c, MultiplayerSessionType.TRADE);
                if (tradeSession != null && tradeSession instanceof TradeSession) {
                    System.out.println("Trade session found for player: " + c.playerName + ". Terminating session.");
                    ((TradeSession) tradeSession).finish(MultiplayerSessionFinalizeType.WITHDRAW_ITEMS);
                } else {
                    System.out.println("No trade session found for player: " + c.playerName);
                }
                break;
