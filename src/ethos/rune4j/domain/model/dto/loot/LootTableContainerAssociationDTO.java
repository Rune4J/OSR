 ...
 */
public class LootTableContainerAssociationDTO {
    ...
    public String toString() {
        return "LootTableContainerAssociationDTO{" +
                "id=" + id +
    ...
    public LootTableContainerAssociationDTO() {
        // empty
    }

    public LootTableContainerAssociationDTO(long id, long lootTableContainerId, long tableId, float weight) {
        this.id = id;
        this.lootTableContainerId = lootTableContainerId;
        this.tableId = tableId;
        this.weight = weight;
